...
homeScreen.label["battlepoints"] = guiCreateLabel(0.02, 0.77, 0.22, 0.07, str("statisticsMenuBattlePointsEarned"), true, homeScreen.staticimage[5])
guiLabelSetVerticalAlign(homeScreen.label["battlepoints"], "center")
homeScreen.label["battlepointsspent"] = guiCreateLabel(0.02, 0.84, 0.22, 0.07, str("statisticsMenuBattlePointsSpent"), true, homeScreen.staticimage[5])
