...
homeScreen.label[5] = guiCreateLabel(0.64, 0.11, 0.24, 0.05, tostring(getPlayerName(localPlayer)):gsub( '#%x%x%x%x%x%x', '' ), true, homeScreen.staticimage[1])
...
homeScreen.label[19] = guiCreateLabel(0.38, 0.00, 0.29, 0.07, "Statistics for "..tostring(getPlayerName(localPlayer)):gsub( '#%x%x%x%x%x%x', '' ), true, homeScreen.staticimage[5])
